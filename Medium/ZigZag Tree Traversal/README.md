<h2><a href="https://www.geeksforgeeks.org/problems/zigzag-tree-traversal/1?page=2&category=Tree,BFS&difficulty=Easy,Medium&sortBy=submissions">ZigZag Tree Traversal</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a Binary Tree. Find the Zig-Zag Level Order Traversal of the Binary Tree.</span></p>
<p>&nbsp;</p>
